...
(* Smoke test for `FPP_localDirac.local_testK_hash_graph_to_ht_then_exact_limit`.

   Uses `maxFacesPerDim=1` and a small `ht` to keep runtime small. *)
...
val fd = FPP_localDirac.local_testK_hash_graph_to_ht_then_exact_limit (g, x, lambda, 1, polHash, ~1, 10);
