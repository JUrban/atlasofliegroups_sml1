...
(* Variant that routes the ParamHash part via the more specified build witness. *)
Theorem program_success_implies_equivalence_via_obligation_stack_via_build:
  !g dirac.
    atlas_eq_is_hol_eq /\ atlas_hash_range /\ ~group_is_compact g /\
    fast_program_succeeds g dirac /\ slow_program_succeeds g ==>
      U_slow g (D_slow g) = U_fast g /\
...
Proof
  ...
  \\ `paramhash_obligations_build_factored g` by
       metis_tac[fast_compute_program_succeeds_imp_paramhash_obligations_build_factored]
  \\ `paramhash_obligations_state_factored g` by
       metis_tac[atlas_hash_range_and_build_factored_imp_state_factored]
...
Theorem program_success_implies_equivalence_via_obligation_stack_paramhash_atlas_eq_via_build:
  !g dirac.
    atlas_eq_is_hol_eq /\ atlas_hash_range /\ atlas_hash_eq_ok /\ ~group_is_compact g /\
    fast_program_succeeds g dirac /\ slow_program_succeeds g ==>
      U_slow g (D_slow g) = U_fast g /\
      bottom_layer_total_ok g dirac (U_fast g)
Proof
  ...
  \\ `paramhash_obligations_build_factored_atlas_eq g` by
  ...
  \\ `paramhash_obligations_state_factored_atlas_eq g` by
       metis_tac[atlas_hash_range_and_build_factored_atlas_eq_imp_state_factored_atlas_eq]
...
(* Most specified ParamHash route: go via the canonical trace-based build-state bundle. *)
Theorem program_success_implies_equivalence_via_obligation_stack_via_build_state:
  !g dirac.
    atlas_eq_is_hol_eq /\ atlas_hash_range /\ ~group_is_compact g /\
    fast_program_succeeds g dirac /\ slow_program_succeeds g ==>
      U_slow g (D_slow g) = U_fast g /\
...
Proof
  ...
  \\ `paramhash_obligations_state_factored g` by
       metis_tac[atlas_hash_range_and_build_state_factored_imp_state_factored]
...
Theorem program_success_implies_equivalence_via_obligation_stack_paramhash_atlas_eq_via_build_state:
  !g dirac.
    atlas_eq_is_hol_eq /\ atlas_hash_range /\ atlas_hash_eq_ok /\ ~group_is_compact g /\
    fast_program_succeeds g dirac /\ slow_program_succeeds g ==>
      U_slow g (D_slow g) = U_fast g /\
...
Proof
  ...
  \\ `paramhash_obligations_state_factored_atlas_eq g` by
       metis_tac[atlas_hash_range_and_build_state_factored_atlas_eq_imp_state_factored_atlas_eq]
...
(* Variant: same end-to-end statement, but routes the ParamHash layer through the
   strongest “build_state_ok + state-based stores” bundle for the canonical
   trace-based model. *)
Theorem program_success_implies_equivalence_via_obligation_stack_paramhash_atlas_eq_via_build_state_stores:
  !g dirac.
    atlas_eq_is_hol_eq /\ atlas_hash_range /\ atlas_hash_eq_ok /\ ~group_is_compact g /\
    fast_program_succeeds g dirac /\ slow_program_succeeds g ==>
      U_slow g (D_slow g) = U_fast g /\
...
Proof
  ...
  \\ `paramhash_obligations_build_state_stores_factored_atlas_eq g` by
       metis_tac[fast_compute_program_succeeds_imp_paramhash_obligations_build_state_stores_factored_atlas_eq]
  \\ `paramhash_obligations_build_state_factored_atlas_eq g` by
       metis_tac[build_state_stores_factored_atlas_eq_imp_build_state_factored_atlas_eq]
  \\ `paramhash_obligations_state_factored_atlas_eq g` by
       metis_tac[atlas_hash_range_and_build_state_factored_atlas_eq_imp_state_factored_atlas_eq]
